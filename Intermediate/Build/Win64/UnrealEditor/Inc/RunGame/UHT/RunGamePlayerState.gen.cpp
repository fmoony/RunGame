...
struct Z_Construct_UFunction_ARunGamePlayerState_AddScore_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "/** Adds the given value to the player's score and broadcasts the change */" },
#endif
		{ "ModuleRelativePath", "RunGamePlayerState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Adds the given value to the player's score and broadcasts the change" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_ARunGamePlayerState_CalculateScoreProcess_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Periodic score calculation callback -- computes cubic polynomial multiplier */" },
#endif
		{ "ModuleRelativePath", "RunGamePlayerState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Periodic score calculation callback -- computes cubic polynomial multiplier" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
...
struct Z_Construct_UFunction_ARunGamePlayerState_OnGameStateChangedCallback_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Reactively starts or stops score calculation based on game state */" },
#endif
		{ "ModuleRelativePath", "RunGamePlayerState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Reactively starts or stops score calculation based on game state" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_ARunGamePlayerState_SetRunGameScore_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|Score" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Sets the player's score to an absolute value and broadcasts if changed */" },
#endif
		{ "ModuleRelativePath", "RunGamePlayerState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Sets the player's score to an absolute value and broadcasts if changed" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FInt64PropertyParams NewProp_NewScore;
...
struct Z_Construct_UFunction_ARunGamePlayerState_SetScoringActive_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|Score" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Enables or disables the score calculation timer */" },
#endif
		{ "ModuleRelativePath", "RunGamePlayerState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Enables or disables the score calculation timer" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UClass_ARunGamePlayerState_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ARunGamePlayerState_AddScore, "AddScore" }, // 4271345072
		{ &Z_Construct_UFunction_ARunGamePlayerState_CalculateScoreProcess, "CalculateScoreProcess" }, // 77567917
		{ &Z_Construct_UFunction_ARunGamePlayerState_GetRunGameScore, "GetRunGameScore" }, // 1226617115
		{ &Z_Construct_UFunction_ARunGamePlayerState_OnGameStateChangedCallback, "OnGameStateChangedCallback" }, // 3142060375
		{ &Z_Construct_UFunction_ARunGamePlayerState_SetRunGameScore, "SetRunGameScore" }, // 685316407
		{ &Z_Construct_UFunction_ARunGamePlayerState_SetScoringActive, "SetScoringActive" }, // 894473958
	};
...
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_RunGamePlayerState_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARunGamePlayerState, ARunGamePlayerState::StaticClass, TEXT("ARunGamePlayerState"), &Z_Registration_Info_UClass_ARunGamePlayerState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARunGamePlayerState), 1253752146U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_RunGamePlayerState_h__Script_RunGame_601347134(TEXT("/Script/RunGame"),
