...
RUNGAME_API UClass* Z_Construct_UClass_ACombatEnemy();
RUNGAME_API UClass* Z_Construct_UClass_ACombatEnemy_NoRegister();
RUNGAME_API UClass* Z_Construct_UClass_UCombatAttacker_NoRegister();
RUNGAME_API UClass* Z_Construct_UClass_UCombatDamageable_NoRegister();
RUNGAME_API UClass* Z_Construct_UClass_UCombatLifeBar_NoRegister();
...
struct Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_RunGame, nullptr, "OnEnemyDied__DelegateSignature", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ACombatEnemy_Statics::NewProp_OnEnemyDied = { "OnEnemyDied", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACombatEnemy, OnEnemyDied), Z_Construct_UDelegateFunction_RunGame_OnEnemyDied__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnEnemyDied_MetaData), NewProp_OnEnemyDied_MetaData) }; // 4267482305
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemy_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatAttacker_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemy, ICombatAttacker), false },  // 3558129176
	{ Z_Construct_UClass_UCombatDamageable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemy, ICombatDamageable), false },  // 2243478353
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Variant_Combat_AI_CombatEnemy_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemy, ACombatEnemy::StaticClass, TEXT("ACombatEnemy"), &Z_Registration_Info_UClass_ACombatEnemy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemy), 3833666720U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Variant_Combat_AI_CombatEnemy_h__Script_RunGame_3727694080(TEXT("/Script/RunGame"),
	Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Variant_Combat_AI_CombatEnemy_h__Script_RunGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Variant_Combat_AI_CombatEnemy_h__Script_RunGame_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
