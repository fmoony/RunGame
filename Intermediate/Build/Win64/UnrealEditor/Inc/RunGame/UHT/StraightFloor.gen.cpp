...
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Actor_Floor_StraightFloor_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStraightFloor, AStraightFloor::StaticClass, TEXT("AStraightFloor"), &Z_Registration_Info_UClass_AStraightFloor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStraightFloor), 97342548U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Actor_Floor_StraightFloor_h__Script_RunGame_1046231888(TEXT("/Script/RunGame"),
