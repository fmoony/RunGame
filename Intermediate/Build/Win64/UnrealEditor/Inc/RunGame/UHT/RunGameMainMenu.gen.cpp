...
struct Z_Construct_UFunction_URunGameMainMenu_OnQuitClicked_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "/** Handles quit button click event, exits the application */" },
#endif
		{ "ModuleRelativePath", "HUD/RunGameMainMenu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Handles quit button click event, exits the application" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_URunGameMainMenu_OnStartClicked_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Handles start button click event, triggers game countdown */" },
#endif
		{ "ModuleRelativePath", "HUD/RunGameMainMenu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Handles start button click event, triggers game countdown" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
...
struct Z_Construct_UClass_URunGameMainMenu_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_URunGameMainMenu_OnQuitClicked, "OnQuitClicked" }, // 3495564007
		{ &Z_Construct_UFunction_URunGameMainMenu_OnStartClicked, "OnStartClicked" }, // 1042230412
...
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_HUD_RunGameMainMenu_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_URunGameMainMenu, URunGameMainMenu::StaticClass, TEXT("URunGameMainMenu"), &Z_Registration_Info_UClass_URunGameMainMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URunGameMainMenu), 870537332U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_HUD_RunGameMainMenu_h__Script_RunGame_645472672(TEXT("/Script/RunGame"),
