...
struct Z_Construct_UFunction_ARunGameGameState_SetCountdownSeconds_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "/** Sets the countdown seconds value and broadcasts OnCountdownUpdated if changed */" },
#endif
		{ "ModuleRelativePath", "RunGameGameState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Sets the countdown seconds value and broadcasts OnCountdownUpdated if changed" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_ARunGameGameState_SetGameState_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|State" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Changes the current game state and broadcasts OnGameStateChanged to all listeners */" },
#endif
		{ "ModuleRelativePath", "RunGameGameState.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Changes the current game state and broadcasts OnGameStateChanged to all listeners" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UClass_ARunGameGameState_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ARunGameGameState_SetCountdownSeconds, "SetCountdownSeconds" }, // 3502115626
		{ &Z_Construct_UFunction_ARunGameGameState_SetGameState, "SetGameState" }, // 2798188665
	};
...
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_RunGameGameState_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARunGameGameState, ARunGameGameState::StaticClass, TEXT("ARunGameGameState"), &Z_Registration_Info_UClass_ARunGameGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARunGameGameState), 1415657607U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_RunGameGameState_h__Script_RunGame_1737964744(TEXT("/Script/RunGame"),
