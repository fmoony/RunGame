...
struct Z_Construct_UFunction_URunGameFloorSubsystem_ClearAllFloors_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "/** Destroys all pooled and active floors, resetting to uninitialized state */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Destroys all pooled and active floors, resetting to uninitialized state" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_HideAllActiveFloors_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Hides all active floors and returns them to the pool */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Hides all active floors and returns them to the pool" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_InitializeFloorSystem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Begins async loading of floor classes and pre-allocates the floor pool */" },
#endif
		{ "CPP_Default_InPreAllocateCount", "10" },
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Begins async loading of floor classes and pre-allocates the floor pool" },
#endif
	};
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_OnFloorClassesLoaded_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Callback when async load finishes; pre-allocates the pool */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Callback when async load finishes; pre-allocates the pool" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_RecycleDistantFloors_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Recycles active floors farther than MaxDistance from the player */" },
#endif
		{ "CPP_Default_MaxDistance", "3000.000000" },
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Recycles active floors farther than MaxDistance from the player" },
#endif
	};
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_RequestFloorAt_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Acquires a floor of the specified class from the pool at the given location */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Acquires a floor of the specified class from the pool at the given location" },
#endif
	};
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_RequestNextFloor_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Acquires the next random floor from the pool at the tracked spawn position */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Acquires the next random floor from the pool at the tracked spawn position" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_ReturnFloor_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Returns a floor actor to the pool, hiding and deactivating it */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Returns a floor actor to the pool, hiding and deactivating it" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_Construct_UFunction_URunGameFloorSubsystem_SpawnInitialFloors_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Spawns the initial chain of straight and random floor segments */" },
#endif
		{ "CPP_Default_RandomCount", "15" },
		{ "CPP_Default_StraightCount", "5" },
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Spawns the initial chain of straight and random floor segments" },
#endif
	};
...
struct Z_Construct_UClass_URunGameFloorSubsystem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnFloorSystemReady_MetaData[] = {
		{ "Category", "RunGame|FloorSystem" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Delegate broadcast when floor subsystem finishes async loading */" },
#endif
		{ "ModuleRelativePath", "WorldSubsystem/RunGameFloorSubsystem.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Delegate broadcast when floor subsystem finishes async loading" },
#endif
	};
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_ClearAllFloors, "ClearAllFloors" }, // 3147197705
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_GetActiveFloorCount, "GetActiveFloorCount" }, // 3650085621
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_GetNextSpawnTransform, "GetNextSpawnTransform" }, // 904542842
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_GetPooledFloorCount, "GetPooledFloorCount" }, // 1294560631
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_HideAllActiveFloors, "HideAllActiveFloors" }, // 945490693
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_InitializeFloorSystem, "InitializeFloorSystem" }, // 1701777826
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_OnFloorClassesLoaded, "OnFloorClassesLoaded" }, // 3378514881
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_RecycleDistantFloors, "RecycleDistantFloors" }, // 3655750213
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_RequestFloorAt, "RequestFloorAt" }, // 1696312127
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_RequestNextFloor, "RequestNextFloor" }, // 1857965061
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_ReturnFloor, "ReturnFloor" }, // 1298260899
		{ &Z_Construct_UFunction_URunGameFloorSubsystem_SpawnInitialFloors, "SpawnInitialFloors" }, // 3870578509
	};
...
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_WorldSubsystem_RunGameFloorSubsystem_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_URunGameFloorSubsystem, URunGameFloorSubsystem::StaticClass, TEXT("URunGameFloorSubsystem"), &Z_Registration_Info_UClass_URunGameFloorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URunGameFloorSubsystem), 3900387892U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_WorldSubsystem_RunGameFloorSubsystem_h__Script_RunGame_45186937(TEXT("/Script/RunGame"),
