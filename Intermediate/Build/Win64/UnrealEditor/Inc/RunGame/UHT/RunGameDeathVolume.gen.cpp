...
struct Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Actor_Volume_RunGameDeathVolume_h__Script_RunGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ARunGameDeathVolume, ARunGameDeathVolume::StaticClass, TEXT("ARunGameDeathVolume"), &Z_Registration_Info_UClass_ARunGameDeathVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARunGameDeathVolume), 1083858010U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RunGame_Source_RunGame_Actor_Volume_RunGameDeathVolume_h__Script_RunGame_1003525926(TEXT("/Script/RunGame"),
